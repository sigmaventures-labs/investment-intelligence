...
- **Filing / earnings dates** — a filings/fundamentals MCP and primary sources (e.g. SEC EDGAR)
- **Macro release calendar** — FRED release dates
- **Event confirmations / news** — a news or web-search MCP

Filing-sourced dates are hard data — cite them. Flag undated or estimated events `[estimate]`.
